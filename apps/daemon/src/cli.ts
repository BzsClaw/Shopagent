...
import { runListingCli } from './listing/cli-listing.js';
...
// external agents (hermes-agent, openclaw, etc.) can drive Open Yourself
...
function printRootHelp() {
  ...
  od mcp [--daemon-url <url>]
      ...
      to pull files from a local Open Yourself project and create
...
Tools exposed:
  list_projects                  list every Open Yourself project
...
// these so a code agent can drive Open Yourself end-to-end without
