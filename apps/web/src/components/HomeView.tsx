...
const AUTHORING_DEFAULT_SCENARIO_INPUTS = {
  artifactKind: 'Open Yourself plugin',
  audience: 'Open Yourself plugin authors',
  topic: 'packaging a reusable workflow as an Open Yourself plugin',
};
...
export function HomeView({
  ...
  async function handlePickWorkingDir() {
    ...
    if (isOpenDesignHostAvailable()) {
      ...
      setError(
        `Couldn't open the folder picker (${'reason' in result ? result.reason : 'host unavailable'}). Please update Open Yourself and try again.`,
      );
      return;
    }
