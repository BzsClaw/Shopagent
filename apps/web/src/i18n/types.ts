...
export interface Dict {
  ...
  'tasksView.eyebrow': string;
  'tasksView.title': string;
  'tasksView.lede': string;
  'tasksView.active': string;
  'tasksView.paused': string;
  'tasksView.templates': string;
  'tasksView.newAutomation': string;
  'tasksView.filterAll': string;
  'tasksView.filterOrbit': string;
  'tasksView.filterLiveArtifact': string;
  'tasksView.filterMemory': string;
  'tasksView.filterDesignSystem': string;
  'tasksView.filterSkills': string;
  'tasksView.filterConnectors': string;
  'tasksView.filterCompression': string;
  'tasksView.filterRelease': string;
  'tasksView.filterQuality': string;
  'tasksView.emptyTitle': string;
  'tasksView.emptyDesc': string;
  'tasksView.lastRun': string;
  'tasksView.run': string;
  'tasksView.edit': string;
  'tasksView.apply': string;
  'tasksView.noTemplatesTitle': string;
  'tasksView.noTemplatesDesc': string;
  'tasksView.runHistory': string;
  'tasksView.latest': string;
  'ds.eyebrow': string;
  'ds.create': string;
  'ds.default': string;
  'ds.yourSystems': string;
  'ds.filterAll': string;
  'ds.filterPublished': string;
  'ds.filterDraft': string;
  'ds.tabLibrary': string;
  'ds.tabOfficial': string;
  'ds.tabTemplates': string;
  'ds.yourTemplates': string;
  'ds.comingSoon': string;
  'ds.createNewTitle': string;
  'ds.createNewDesc': string;
