...
export const en: Dict = {
  ...
  'settings.mcpRunningNote':
    'Open Yourself must be running for MCP tool calls to succeed. If you started your coding agent before opening Open Yourself, restart the agent so it can reach the live daemon.',
  ...
  'homeHero.subtitlePrefix': 'Open yourself, look inward, find what you need.',
  'homeHero.placeholder': 'Describe what you want…',
  'homeHero.placeholderActive': 'Edit the example or write your own…',
  ...
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with Open Yourself and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'tasksView.eyebrow': 'Scheduled agent sessions',
  'tasksView.title': 'Automations',
  'tasksView.lede': 'Plan recurring conversations for project work, Orbit digests, and live artifacts.',
  'tasksView.active': 'Active',
  'tasksView.paused': 'Paused',
  'tasksView.templates': 'Templates',
  'tasksView.newAutomation': 'New automation',
  'tasksView.filterAll': 'All',
  'tasksView.filterOrbit': 'Orbit',
  'tasksView.filterLiveArtifact': 'Live artifacts',
  'tasksView.filterMemory': 'Memory',
  'tasksView.filterDesignSystem': 'Design systems',
  'tasksView.filterSkills': 'Skills',
  'tasksView.filterConnectors': 'Connectors',
  'tasksView.filterCompression': 'Compression',
  'tasksView.filterRelease': 'Release',
  'tasksView.filterQuality': 'Quality',
  'tasksView.emptyTitle': 'No automations yet',
  'tasksView.emptyDesc': 'Create one from a template or start with a blank schedule.',
  'tasksView.lastRun': 'Last run {time}',
  'tasksView.run': 'Run',
  'tasksView.edit': 'Edit',
  'tasksView.apply': 'Apply',
  'tasksView.noTemplatesTitle': 'No templates in this category yet.',
  'tasksView.noTemplatesDesc': 'Try a different filter, or start from a blank automation.',
  'tasksView.runHistory': 'Run history',
  'tasksView.latest': 'Latest {n}',
  'ds.eyebrow': 'Design Systems',
  'ds.create': 'Create',
  'ds.default': 'Default',
  'ds.yourSystems': 'Your systems',
  'ds.filterAll': 'All',
  'ds.filterPublished': 'Published',
  'ds.filterDraft': 'Draft',
  'ds.tabLibrary': 'Library',
  'ds.tabOfficial': 'Official presets',
  'ds.tabTemplates': 'Templates',
  'ds.yourTemplates': 'Your templates',
  'ds.comingSoon': 'Coming soon',
  'ds.createNewTitle': 'Create new design system',
  'ds.createNewDesc': 'Teach Open Yourself your brand, product, code, assets, and design references.',
