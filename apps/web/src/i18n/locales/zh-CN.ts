...
export const zhCN: Dict = {
  ...
  'homeHero.title': '你想要什么',
  'homeHero.templatesScrollHint': '向上滑动探索更多模板',
  'homeHero.templatesCollapse': '收起模板',
  'homeHero.subtitlePrefix': '开放自己，向内求，找到自己所需。',
  'homeHero.placeholder': '描述你想要什么…',
  'homeHero.placeholderActive': '编辑示例描述，或写下你自己的需求…',
  'homeHero.skills': '技能',
  'homeHero.addMenu': '添加',
  ...
  'pluginsHome.subtitle': '当前运行环境内置的 Open Yourself 工作流。选择一个加载 starter prompt，或浏览插件市场查看更多。',
  'pluginsHome.browseRegistry': '浏览插件市场',
  'pluginsHome.count': '{filtered} / {total}',
  'pluginsHome.loadingCatalog': '正在加载目录…',
  'pluginsHome.emptyCatalog': '目录为空。Open Yourself 会随附内置插件，如果这里一直为空，请尝试重启 daemon。',
  ...
  'tasksView.eyebrow': '定时 Agent 会话',
  'tasksView.title': '自动化',
  'tasksView.lede': '为项目工作、Orbit 摘要和实时产物规划周期性对话。',
  'tasksView.active': '活跃',
  'tasksView.paused': '暂停',
  'tasksView.templates': '模板',
  'tasksView.newAutomation': '新建自动化',
  'tasksView.filterAll': '全部',
  'tasksView.filterOrbit': 'Orbit',
  'tasksView.filterLiveArtifact': '实时产物',
  'tasksView.filterMemory': '记忆',
  'tasksView.filterDesignSystem': '设计系统',
  'tasksView.filterSkills': '技能',
  'tasksView.filterConnectors': '连接器',
  'tasksView.filterCompression': '压缩',
  'tasksView.filterRelease': '发布',
  'tasksView.filterQuality': '质量',
  'tasksView.emptyTitle': '暂无自动化',
  'tasksView.emptyDesc': '从模板创建或从空白开始。',
  'tasksView.lastRun': '上次运行 {time}',
  'tasksView.run': '运行',
  'tasksView.edit': '编辑',
  'tasksView.apply': '应用',
  'tasksView.noTemplatesTitle': '此分类暂无模板。',
  'tasksView.noTemplatesDesc': '尝试其他筛选，或从空白开始。',
  'tasksView.runHistory': '运行历史',
  'tasksView.latest': '最新 {n} 条',
  'ds.eyebrow': '设计系统',
  'ds.create': '创建',
  'ds.default': '默认',
  'ds.yourSystems': '我的系统',
  'ds.filterAll': '全部',
  'ds.filterPublished': '已发布',
  'ds.filterDraft': '草稿',
  'ds.tabLibrary': '资源库',
  'ds.tabOfficial': '官方预设',
  'ds.tabTemplates': '模板',
  'ds.yourTemplates': '我的模板',
  'ds.comingSoon': '即将推出',
  'ds.createNewTitle': '创建设计系统',
  'ds.createNewDesc': '教 Open Yourself 认识你的品牌、产品、代码、素材和设计参考。',
  ...
  'useEverywhere.section.mcp.intro': 'Open Yourself 内置 Model Context Protocol 服务器（`od mcp`），让任何支持 MCP 的客户端（Cursor、Claude Code、Antigravity、VS Code Copilot Chat、openclaw、hermes）都能发现 Open Design 工具（列出技能、渲染预览、生成媒体、运行插件），无需手动 shell 调用。daemon 会通过 `GET /api/mcp/install-info` 为主流客户端发布可直接粘贴的安装片段。',
